...
def create_meta_data_file(server_dir):
    ...
    selected_version = input("Selecciona la versión de meta-data (e.g., v1, v2, v3, v4): ").strip()
    if selected_version not in versions:
        print(f"{COLOR_YELLOW}Versión no válida. Saliendo del programa.{COLOR_RESET}")
        sys.exit(1)

    # URL base para los archivos meta-data
    base_url = "https://raw.githubusercontent.com/DonComProject/arenita/main/src/iso-conf"
